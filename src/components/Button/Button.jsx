  ...
  return (
    <div>
      ...
      <div style={{ display: "flex" }}>
        <div>
          <div className="my-5 mx-5 bg-main-piccolo hover:bg-hover-main-piccolo text-main-piccolo focus:ring-1 focus:ring-offset-1 focus:ring-main-bulma focus:ring-rounded-md rounded">
            <button className="focus:ring-1 focus:ring-offset-1 focus:ring-main-bulma focus:ring-rounded-md rounded">Piccolo</button>
          </div>
